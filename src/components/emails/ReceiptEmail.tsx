...
export const ReceiptEmail = ({
    ...
    return (
        <Html>
            <Head />
            <Preview>Ваша квитанция ByteBay</Preview>
                ...
                <Container style={container}>
                    <Section>
                        ...
                        <Column align="right" style={tableCell}>
                            <Text style={heading}>Квитанция</Text>
                        </Column>
                    </Section>
                    ...
                    <Section style={productTitleTable}>
                        <Text style={productsTitle}>Итого</Text>
                    </Section>
                    ...
                    <Section>
                        ...
                        >
                            <Text style={productTitle}>Комиссия</Text>
                        </Column>
                    ...
                    <Text style={footerLinksWrapper}>
                        <Link href="#">Настройки учетной записи</Link> •{" "}
                        <Link href="#">Условия продажи</Link> •{" "}
                        <Link href="#">Политика конфиденциальности</Link>
                    </Text>
                    <Text style={footerCopyright}>
                        Copyright © 2023 ByteBay Inc. <br />{" "}
